	;--- TCP console for the TCP/IP UNAPI 1.1
	;    By Konami Man, 2/2014
...
PRESENT_S:
	db	"TCP Console (simplified Telnet client) for the TCP/IP UNAPI 1.0",13,10
	db	"By Konamiman, 2/2014",13,10,10,"$"
